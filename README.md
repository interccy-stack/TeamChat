================================================================================
  TeamChat v5.3.6  —  双注册模式 · AI决策· AI主持圆桌会谈 · AI群聊 · AI分身 · AI PRO浏览器扩展 · AI协作平台 · AI邮箱 · 工业级巢邮箱系统 · 多标签 · 圆桌动画 · PPT回放 · 头脑风暴 · 文件架 · 轻音乐 · 新手引导 · 串串频道 · 频道广播站 · 原创作者AI · 串串汇 
================================================================================
...
================================================================================
   v5.3.6
    +  🚀 修复智能体列表       — 更加稳定的方案
    +  🚀 新增AI决策          — 本地智能体和LLM语言模型真实调用，参考 AIChatProxy
   v5.3.3
    +  🔗 双注册模式 / Dual Registration Mode-同时支持应用栏目 + 侧边栏显示（QwenPaw 2.0 兼容） 
    +  🚀 AI决策视图修复       — 修复了AI决策视图渲染位置问题，现在正确显示为独立页面
   v5.2.2 (2026-07-27)
    +  📁 HTTP 504 修复       — 已知BUG
   v5.2.0 (2026-07-26)
